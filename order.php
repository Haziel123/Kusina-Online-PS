...
<div class="container">
		...
		<?php require_once 'process3.php'; ?>
			...
			<input type="text" class="form-control form-control-sm" name="customer_id" placeholder="customer id" required>
		...
		<button type="button" class="btn btn-primary btn-block button2" data-dismiss="modal">Close</button>
			...
			<label class="col-form-label">Customer ID:</label>
			<input type="text" class="form-control form-control-sm" name="customer_id" placeholder="customer id" value="<?php echo $customer_id; ?>" required>
			<label class="col-form-label">timestamp:</label>
