<?php
	...
	if (isset($_POST['add'])) {
		...
		$mysqli->query("INSERT INTO customer (customer_id, first_name, last_name, middle_initial, phone_number, province, street, barangay, city) VALUES('$customer_id', '$first_name', '$last_name', '$middle_initial', '$phone_number', '$province', '$street', '$barangay', '$city')") or die($mysqli->error);
